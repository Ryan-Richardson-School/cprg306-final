        ...
        <main>
            <div className="flex-col flex h-screen justify-center items-center">
                <div className="flex fixed top-7 text-white w-70 text-2xl justify-center items-center mb-15">
                    <div>
                    <h1 className="rainbow-text text-[70px]">NCR Movie Watchlist</h1> 
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="mt-5 text-center">
                        <input type="text" placeholder="Enter Movie Title..." className="border-2 rounded-md pl-2 w-64 rainbow-text text-[30px]"></input>
                        <button className="border-2 rounded-md pl-2 pr-2 text-center w-24 rainbow-text text-[30px]">Search</button>
                    </div>
                </div>
