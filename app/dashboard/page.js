          ...
          {watchlist.map(movie => (
            ...
            >
              ...
              <div className="mb-3">
                {movie.watched ? (
                  ...
                  <button
                    ...
                    className="border-2 px-4 py-2 rounded-md rainbow-text hover:bg-green-500 hover:text-white transition text-[30px] cursor-pointer"
                  >
                    Mark as Watched
                  </button>
                )}
              ...
              <button
                ...
                className="border-2 px-4 py-2 rounded-md rainbow-text hover:bg-red-500 hover:text-white transition text-[30px] cursor-pointer"
              >
                Remove
              </button>
            </div>
